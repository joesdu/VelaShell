...
public partial class MessageDialog : Window
{
        ...
        MessageDialogKind kind = MessageDialogKind.Info)
    {
        ...
        dialog.Configure(title, message, kind, Strings.OK, cancelText: null, danger: false);
    ...
    public static Task<bool> ConfirmAsync(Window owner, string title, string message,
        ...
        MessageDialogKind kind = MessageDialogKind.Question, bool danger = false)
    {
        var dialog = new MessageDialog();
    ...
    public static async Task<string?> PromptAsync(Window owner, string title, string initialValue,
        string? message = null)
    {
        var dialog = new MessageDialog();
        dialog.Configure(title, message, MessageDialogKind.Question, Strings.OK, Strings.Cancel, danger: false);
    ...
    public static Task<bool> ShowCustomAsync(Window owner, string title, Control content,
        string? confirmText = null, string? cancelText = null, bool showCancel = true,
        MessageDialogKind kind = MessageDialogKind.Info)
    {
        var dialog = new MessageDialog();
        dialog.Configure(title, message: null, kind, confirmText ?? Strings.OK,
            showCancel ? cancelText ?? Strings.Cancel : null, danger: false);
    ...
    private void Close_Click(object? sender, Avalonia.Interactivity.RoutedEventArgs e) => Close(false);
