...
public class ScrollOffsetTests
{
    ...
    public void AtLiveBottom_AlwaysStaysAtBottom()
    {
        ...
        Assert.AreEqual(0, PulseTerminalControl.PinScrollOffset(0, 10, 25));
    }
    ...
    public void ScrolledUp_PinsViewByGrowingWithScrollback()
    {
        ...
        Assert.AreEqual(8, PulseTerminalControl.PinScrollOffset(5, 10, 13));
    }

    [TestMethod]
    public void ScrolledUp_NoGrowth_KeepsOffset()
    {
        Assert.AreEqual(5, PulseTerminalControl.PinScrollOffset(5, 10, 10));
    }
    ...
    public void ScrolledUp_ClampsToNewScrollback()
    {
        ...
        Assert.AreEqual(12, PulseTerminalControl.PinScrollOffset(100, 10, 12));
    }
    ...
    public void ScrollbackShrank_ClampsDown()
    {
        ...
        Assert.AreEqual(4, PulseTerminalControl.PinScrollOffset(5, 10, 4));
    }

    [TestMethod]
    public void EmptyScrollback_ReturnsZero()
    {
        Assert.AreEqual(0, PulseTerminalControl.PinScrollOffset(5, 10, 0));
    }
}
