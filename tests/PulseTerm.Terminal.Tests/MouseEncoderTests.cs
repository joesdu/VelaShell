...
public class MouseEncoderTests
{
    ...
    {
        var bytes = MouseEncoder.Encode(TerminalMouseEventType.Press, TerminalMouseButton.Left,
    ...
    {
        var m = Modes(MouseTracking.Normal, MouseEncoding.Sgr);

        var press = MouseEncoder.Encode(TerminalMouseEventType.Press, TerminalMouseButton.Left, 4, 2, false, false, false, m);
        var release = MouseEncoder.Encode(TerminalMouseEventType.Release, TerminalMouseButton.Left, 4, 2, false, false, false, m);
    ...
    {
        var bytes = MouseEncoder.Encode(TerminalMouseEventType.Release, TerminalMouseButton.Left,
    ...
    {
        var bytes = MouseEncoder.Encode(TerminalMouseEventType.Move, TerminalMouseButton.Left,
    ...
    {
        var bytes = MouseEncoder.Encode(TerminalMouseEventType.Move, TerminalMouseButton.None,
